...
'''
some image editing function
1. `mask_object`: Mask an object (with SAM result)
2. `box_object`: Box an object (with SAM result)
3. `outline_object`: Outline an object (with SAM result)
4. `turn_grayscale_image`: Turn into grayscale
5. Patch reorder
6. `concatenate_images_horizontal`: Combine two images
'''
